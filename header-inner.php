...
<body>
    <header class="header header_page" id="header">
    ...
    <div class="dropdown-menu">
        <div class="dropdown-menu__item">
            <div class="dropdown-menu__title">menu</div>
                 <?php 
                    wp_nav_menu( [
                        'theme_location'  => 'inner_menu_dropdown',
                        'container'       => null, 
                        'menu_class'      => 'dropdown-menu__list inner_menu', 
                        'menu_id'         => 'dropdown',
                        'echo'            => true,
                    ] );
                ?>
